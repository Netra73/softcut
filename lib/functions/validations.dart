...
String? validateAcNumber(String value,String error) {
  String pattern = r'(^(?:[+0]12)?[0-12]{10,12}$)';
  RegExp regExp = new RegExp(pattern);
  if (!regExp.hasMatch(value)) {
    return error;
  } else {
...
String? numberRequired(String value,String error) {
  if (value == null || value.isEmpty) {
    return error;
  } else {
    return validateAcNumber(value,error);
  }
}
